...
export async function generateMetadata() {
  return {
    title: "Business Images - Professional Business Photos Free",
    description:
      "Discover high-quality AI-generated business images for marketing, presentations, and professional use. Perfect for corporate branding and business communications.",
    keywords:
      "business ai images, professional photos, corporate branding, business marketing, ai generated business photos",
    robots: "index, follow",
  };
}
...
export default async function Business() {
  ...
  const images = await getCategoryImages("Business");
  return (
    <div>
      <h1 className="text-center font-bold md:text-[32px] text-[27px] text-gray-900 py-[30px] capitalize px-[10px]">
        Best Business Images - High Quality Ai Generated Photos
      </h1>{" "}
      <section
