...
export async function generateMetadata() {
  return {
    title: "Education AI Images - Education & Learning Photos",
    description:
      "Explore AI-generated education images for education, learning, and education services. Perfect for education marketing and business presentations.",
    keywords:
      "education ai images, learning photos, education images, education marketing, ai generated education photos",
    robots: "index, follow",
  };
}
...
export default async function Education() {
  ...
  const images = await getCategoryImages("Education & Learning");
  return (
    <div>
      <h1 className="text-center font-bold md:text-[32px] text-[27px] text-gray-900 py-[30px] capitalize px-[10px]">
        Best Education & Learning Images - Free AI Generated Photos
      </h1>{" "}
      <section
