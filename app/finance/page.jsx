...
export async function generateMetadata() {
  return {
    title: "Finance AI Images - Financial & Investment Photos",
    description:
      "Explore AI-generated finance images for investment, banking, and financial services. Perfect for financial marketing and business presentations.",
    keywords:
      "finance ai images, investment photos, banking images, financial marketing, ai generated finance photos",
    robots: "index, follow",
  };
}
...
export default async function Finance() {
  ...
  const images = await getCategoryImages("Finance");
  return (
    <div>
      <h1 className="text-center font-bold md:text-[32px] text-[27px] text-gray-900 py-[30px] capitalize px-[10px]">
        Best Free AI Generated Finance Images - Realistic Ultra High Quality
      </h1>{" "}
      <section
