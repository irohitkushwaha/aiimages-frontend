...
export default function SignUpComponent() {
  ...
  const handleGoogleSignUp = () => {
    ...
    // Handle Google OAuth sign up here
  };
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 border border-gray-200 mt-[100px]">
          ...
          <div className="space-y-6">
            ...
            <button
              ...
              className="w-full bg-gray-600 hover:bg-gray-700 text-white font-medium py-3 px-4 rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-white"
            >
              Sign Up
            </button>
