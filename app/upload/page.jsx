// import { ImagePlus, Info, CheckCircle, Upload as UploadIcon } from 'lucide-react';
// import UploadImageForm from '@/components/features/uploadimgform';
...
//     {
//       title: 'Image Format',
//       description: 'Only AVIF format is accepted for optimal compression and quality',
//       icon: <ImagePlus className="w-5 h-5 text-blue-600" />
//     },
//     {
//       title: 'AI Generated Only',
//       description: 'Images must be created using AI tools like Midjourney, DALL-E, or Stable Diffusion',
//       icon: <UploadIcon className="w-5 h-5 text-green-600" />
//     },
//     {
//       title: 'Quality Standards',
//       description: 'High resolution images with clear, professional quality are preferred',
//       icon: <CheckCircle className="w-5 h-5 text-purple-600" />
//     },
//     {
//       title: 'Content Guidelines',
//       description: 'No copyrighted material, inappropriate content, or low-quality images',
...
//             Share your AI-generated artwork with our community. Fill out the details below to upload your image.
//           </p>
//         </header>
...
//                 <h3 className="text-xl font-bold text-green-900">Available Categories</h3>
//               </div>
...
//                 <h3 className="text-xl font-bold text-blue-900">SEO Best Practices</h3>
//               </div>
...
// pages/upload/page.jsx (Server Component)


// pages/upload/page.jsx - Complete AI Image Upload Page (Server Component)
import { Upload, Image as ImageIcon, ImagePlus, Info, CheckCircle, Upload as UploadIcon } from 'lucide-react';
            ...
            <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200">
              ...
              <form className="space-y-6" id="upload-form">
                ...
                <div>
                  ...
                  <div className="relative border-2 border-dashed rounded-lg p-8 text-center transition-colors border-gray-300 hover:border-gray-400" id="upload-area">
                    <input
                      type="file"
                      name="image"
                      accept=".avif"
                  ...
                  <p className="mt-1 text-sm text-red-600 hidden" id="image-error"></p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-red-600 hidden" id="alt-error"></p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-red-600 hidden" id="caption-error"></p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-red-600 hidden" id="imageTitle-error"></p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-red-600 hidden" id="category-error"></p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-sm text-red-600 hidden" id="pageTitle-error"></p>
                </div>
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm text-red-600 hidden" id="pageSlug-error"></p>
                </div>
                ...
                <div>
                  ...
                  <div className="flex justify-between items-center mt-1">
                    <p className="text-sm text-red-600 hidden" id="pageDescription-error"></p>
                    <p className="text-sm text-gray-500 ml-auto" id="char-count">
                      0/160 characters
                    </p>
                  </div>
                </div>
              ...
              {/* Status Messages */}
              <div id="success-message" className="hidden mt-6 bg-green-50 border border-green-200 rounded-lg p-4">
              ...
              <div id="error-message" className="hidden mt-6 bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex items-center">
